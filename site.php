<?PHP
	...
	$app->post('/checkout', function(){
		...
		if(!isset($_POST['desaddres']) || $_POST['desaddres'] === ''){
		...
		if(!isset($_POST['descoutry']) || $_POST['descoutry'] === ''){
	...
	$app->get('/login', function(){
		...
		$page->setTpl('login', [
			'error'=>User::getErrror(),
			'esrrorRegister'=>User::getErrorRegister(),
	...
	$app->post('/register', function(){
		...
		if(User::checkLoginExist() == true){
			
			User::setErrorRegister("Este email já esta sendo usado por outro usuário.");
			header("Location: /login");
			exit;
		}		
	...
	$app->post('/profile', function(){
		...
		if($_POST['desemail'] != $user->getdesemail()){
			if(User::desLoginExists($_POST['desemail']) == true){
	...
	$app->get('/profile/orders/:idorder', function($idorder){
		...
		$app->get('/profile/change-password', function(){
			...
			$page->setTpl("profile-change-password", [
				'changPassError'=>User::getError(),
				'changPassSucess'=>User::getSucess()
			]);
		});
	});
